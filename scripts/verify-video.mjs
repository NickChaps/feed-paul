...
frames.push(await page.evaluate(()=>{const c=document.createElement('canvas');c.width=100;c.height=100;c.getContext('2d').drawImage(document.querySelector('video'),0,0,100,100);return c.toDataURL();}));}
